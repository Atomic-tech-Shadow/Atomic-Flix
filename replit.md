...
- July 08, 2025. Terminology standardization: Replaced all "popular" references with "trending" throughout the codebase for consistency. Updated anime-sama.tsx to use trendingAnimes state variable, loadTrendingAnimes function, and "🔥 Contenu Trending" section title. Updated mobile HomeScreen.tsx to match web terminology. All UI text and variable names now consistently use "trending" instead of "popular" for better semantic accuracy.
