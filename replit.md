...
- July 12, 2025. Mobile build system optimization: Enhanced EAS Build configuration with Android 7+ compatibility (minSdkVersion 24), resolved keystore generation issues by implementing automatic credentials, optimized Gradle commands for faster builds, and created accelerated build profiles including local build options. Added comprehensive build guides and troubleshooting documentation for reliable APK generation.
