          ...
          <Card className="atomic-card border-purple-500/20 bg-black/40 backdrop-blur-md">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4 space-y-2">
                <h4 className="font-semibold text-purple-400">Avertissement Important</h4>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4 space-y-2">
                <h4 className="font-semibold text-cyan-400">Confidentialité</h4>
                <p className="text-gray-300 text-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <Button 
                    ...
                    className="w-full atomic-bg-gradient hover:from-cyan-600 hover:to-purple-700 text-white"
                  >
